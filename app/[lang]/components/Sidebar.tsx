...
export default async function Sidebar({ type }: { type: string }) {
  ...
  let common: string = "w-2 h-2 rounded-full";
  let bullet: string[] = [common + " bg-pink-500", common + " bg-slate-500"];
  console.log("type", type);
  const posts = await getPostsMeta();
  return (
    <aside className="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-l rtl:border-l-0 rtl:border-r dark:bg-gray-900 dark:border-gray-700">
      <div>
