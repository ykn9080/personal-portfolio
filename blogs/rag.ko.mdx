...
<SearchShow
  ...
  script1="~/script/condaremote.sh rag_textsplit2.py"
/>
  ...
  arr={[
    {
      ...
      content: (
        <SearchShow
          ...
          script1="~/script/condaremote.sh rag_embedding.py"
        />
      ),
    },
    {
      ...
      content: (
        <SearchShow
          ...
          script1="~/script/condaremote.sh rag_embedding_hf1.py"
        />
      ),
    },
    {
      ...
      content: (
        <SearchShow
          ...
          script1="~/script/condaremote.sh rag_embedding_hf2.py"
        />
      ),
    },
  ]}
  ...
  arr={[
    {
      ...
      content: (
        <SearchShow
          ...
          script1="~/script/condaremote.sh rag_vectorstore1.py"
        />
      ),
    },
    {
      ...
      content: (
        <SearchShow
          ...
          script1="~/script/condaremote.sh rag_vectorstore2.py"
        />
      ),
    },
    {
      ...
      content: (
        <SearchShow
          ...
          script1="~/script/condaremote.sh rag_vectorstore3.py"
        />
      ),
    },
  ]}
  ...
  arr={[
    {
      ...
      content: (
        <SearchShow
          ...
          script1="~/script/condaremote.sh rag_retrieval.py"
        />
      ),
    },
    {
      ...
      content: (
        <SearchShow
          ...
          script1="~/script/condaremote.sh rag_retrieval2.py"
        />
      ),
    },
  ]}
