...
<div className="flex">
  ![npm](https://img.shields.io/npm/v/imcformbuilder) ![npm bundle
  size](https://img.shields.io/bundlephobia/min/imcformbuilder?style=plastic)
...
```sh # Github git clone https://github.com/ykn9080/imcDashboard npm start //local
init docker-compose up //using docker
...
1. onFinish: By clicking submit button, onFinish function returns a value as object.
   ...
   Return data is key value object
