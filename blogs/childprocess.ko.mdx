...
type: interest
language: kr
featureImage: /images/interest/child_process.jpg
thumb: /images/interest/child_process.png
github: https://github.com/ykn9080/childprocess
demo:
videoSourceURL:
videoTitle:
excerpt: single thread, event driven 방식으로 작동되는 nodejs에서 별도의 thread가 필요한 경우 child_process를 사용한다.
---
...
> 아래의 예제 코드는 client에서 서버의 shell script를 실행하려는 예이다.
> 이때 main nodejs의 thread 이외에 새로운 프로세스 즉 child process를 생성하여 실행할 수 있다.
